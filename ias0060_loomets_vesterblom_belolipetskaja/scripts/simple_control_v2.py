...
@author: Christian Meurer, Team Scitos ias0060_loomets_vesterblom_belolipetskaja
@date: January 2022
...
# TEST - et ei jookseks kokku kui wp on otsas - OK
# TEST - testida Kp, Ki ja Kd - OK
# TEST - kontrollida kas pid sai oigesti implementeeritud - OK
# proovida PID nullida kui WP vahetub
# koigepealt keerab ennast ja siis liigub (X on 0, angular keerab teatud deltaga)
